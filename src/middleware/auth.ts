...
// Autenticação específica para SSE (EventSource não suporta headers customizados)
export async function authenticateSSE(request: AuthenticatedRequest, reply: FastifyReply) {
  try {
    // Tenta pegar o token do query parameter primeiro (para SSE)
